...
from llm_router_utils.sglang.srt.entrypoints.openai.protocol import Function, Tool
...
class TestHunyuanDetectorHasToolCall(unittest.TestCase):
    def setUp(self):
...
class TestHunyuanDetectorDetectAndParse(unittest.TestCase):
    def setUp(self):
...
class TestHunyuanDetectorArgDeserialization(unittest.TestCase):
...
class TestHunyuanDetectorStreaming(unittest.TestCase):
    def setUp(self):
        self.tools = _make_tools()
...
class TestHunyuanDetectorStructureInfo(unittest.TestCase):
    def setUp(self):
        self.detector = HunyuanDetector()
...
class TestHunyuanDetectorFunctionCallParser(unittest.TestCase):
