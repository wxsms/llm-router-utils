...
from llm_router_utils.sglang.srt.function_call.minimax_m3 import MINIMAX_NS_TOKEN, MinimaxM3Detector
...
class TestMinimaxM3HasToolCall(unittest.TestCase):
    def setUp(self):
...
class TestMinimaxM3DetectAndParse(unittest.TestCase):
    def setUp(self):
...
class TestMinimaxM3NoneNullRegression(unittest.TestCase):
    def setUp(self):
        self.tools = _make_tools()
...
class TestMinimaxM3Streaming(unittest.TestCase):
    def setUp(self):
        self.tools = _make_tools()
...
class TestMinimaxM3Malformed(unittest.TestCase):
    def setUp(self):
        self.tools = _make_tools()
...
class TestMinimaxM3TopLevelOneOf(unittest.TestCase):
    def setUp(self):
        self.tools = [
            Tool(
                type="function",
