...
from llm_router_utils.sglang.srt.function_call.core_types import StreamingParseResult
...
from llm_router_utils.sglang.srt.function_call.gemma4_detector import (
    Gemma4Detector,
    _parse_gemma4_args,
    _parse_gemma4_array,
    _parse_gemma4_value,
...
from llm_router_utils.sglang.srt.function_call.utils import get_schema_properties
...
def _shared_tokenizer(path: str):
    ...
    return _AT.from_pretrained(path)
...
class TestGlm4MoeDetector(unittest.TestCase):
    ...
    def test_parse_arguments_preserves_underscore_in_string_args(self):
        ...
        from llm_router_utils.sglang.srt.function_call.glm4_moe_detector import parse_arguments
...
class TestGlm47MoeDetector(unittest.TestCase):
    ...
    def test_parse_arguments_preserves_underscore_in_string_args(self):
        ...
        from llm_router_utils.sglang.srt.function_call.glm47_moe_detector import parse_arguments
    ...
    def test_required_tool_choice_falls_back_when_native_tag_is_unavailable(self):
        ...
        from llm_router_utils.sglang.srt.function_call.function_call_parser import FunctionCallParser
        from llm_router_utils.sglang.srt.function_call.glm47_moe_detector import (
            _glm47_native_structural_tag_available,
        )

        with patch(
            "llm_router_utils.sglang.srt.function_call.glm47_moe_detector.get_model_structural_tag",
            None,
        ):
...
class TestGetStructureConstraint(unittest.TestCase):
    ...
    def test_inkling_auto_constrains_json_after_tool_trigger(self):
        ...
        from llm_router_utils.sglang.srt.parser.inkling_tokenizer import INKLING_SPECIAL_TOKEN_IDS
