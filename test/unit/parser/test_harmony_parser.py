...
from llm_router_utils.sglang.srt.parser.harmony_parser import (
    CanonicalStrategy,
    HarmonyParser,
    TextStrategy,
    iter_tokens,
...
class TestAdditionalEdgeCases(unittest.TestCase):
    ...
    def test_iter_tokens_unknown_token_no_closing(self):
        ...
        from llm_router_utils.sglang.srt.parser.harmony_parser import iter_tokens
    ...
    def test_canonical_standalone_end_token_filtered(self):
        ...
        from llm_router_utils.sglang.srt.parser.harmony_parser import CanonicalStrategy
    ...
    def test_text_strategy_commentary_only(self):
        ...
        from llm_router_utils.sglang.srt.parser.harmony_parser import TextStrategy
