...
class TestConversationGetPrompt(unittest.TestCase):
...
class TestConversationMethods(unittest.TestCase):
    def _make_conv(self):
        return Conversation(
            name="test",
            roles=("User", "Assistant"),
...
class TestGenerateEmbeddingConvs(unittest.TestCase):
...
class TestGetFullMultimodalTextPrompt(unittest.TestCase):
...
class TestGenerateChatConv(unittest.TestCase):
