...
from llm_router_utils.sglang.srt.parser.reasoning_parser import (
    Apertus2509Detector,
...
class TestInklingDetector(unittest.TestCase):
    ...
    def test_control_token_inside_tool_header_shares_the_full_alphabet(self):
        ...
        from llm_router_utils.sglang.srt.function_call.inkling_detector import (
...
class TestGlm45Detector(unittest.TestCase):
...
class TestNemotron3Detector(unittest.TestCase):
    def setUp(self):
...
class TestApertus2509DetectorForceNonempty(unittest.TestCase):
...
class TestStreamingChunkSizeInvariance(unittest.TestCase):
...
class TestGptOssDetector(unittest.TestCase):
    ...
    def setUp(self):
        from llm_router_utils.sglang.srt.parser.reasoning_parser import GptOssDetector
...
class TestMiniMaxAppendThinkDetector(unittest.TestCase):
    """Test cases for MiniMaxAppendThinkDetector."""

    def setUp(self):
        from llm_router_utils.sglang.srt.parser.reasoning_parser import MiniMaxAppendThinkDetector
...
class TestMiniMaxM3Detector(unittest.TestCase):
    """Test cases for MiniMaxM3Detector multi-turn stray-closer handling."""

    def _detector(self, force_reasoning=False):
        from llm_router_utils.sglang.srt.parser.reasoning_parser import MiniMaxM3Detector
...
class TestReasoningParserAdvanced(unittest.TestCase):
...
class TestContinueFinalMessage(unittest.TestCase):
...
class TestGptOssDetectorToolCall(unittest.TestCase):
...
class TestPoolsideV1Registered(unittest.TestCase):
...
class TestCohereCommand4DetectorFinish(unittest.TestCase):
...
class TestGraniteThinkingDetector(unittest.TestCase):
    def setUp(self):
