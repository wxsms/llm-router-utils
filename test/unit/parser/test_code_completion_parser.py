...
from llm_router_utils.sglang.srt.entrypoints.openai.protocol import CompletionRequest
...
class TestRegisterCompletionTemplate(unittest.TestCase):
...
class TestGenerateCompletionPrompt(unittest.TestCase):
...
class TestGenerateCompletionPromptFromRequest(unittest.TestCase):
    ...
    def test_nonempty_suffix_uses_fim_template(self):
        ...
        with patch(
            "llm_router_utils.sglang.srt.parser.code_completion_parser.completion_template_name",
            "deepseek_coder",
        ):
...
class TestSetCompletionTemplate(unittest.TestCase):
    def test_set_only_once(self):
        """Test that set_completion_template only sets the name once."""
        import llm_router_utils.sglang.srt.parser.code_completion_parser as module
