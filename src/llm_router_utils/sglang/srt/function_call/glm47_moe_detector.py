...
from llm_router_utils.sglang.srt.entrypoints.openai.protocol import Tool, ToolChoice
from llm_router_utils.sglang.srt.function_call.base_format_detector import (
    BaseFormatDetector,
    StructuralTag,
