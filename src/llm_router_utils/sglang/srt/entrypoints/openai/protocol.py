...
from llm_router_utils.sglang.utils import convert_json_schema_to_str
...
class ChatCompletionMessageContentImageURL(BaseModel):
    ...
    def validate_content_hash(cls, value: Optional[str]) -> Optional[str]:
        # Inlined from sglang.srt.multimodal.cache.identity.parse_content_hash
        # (this repo does not retain the multimodal processing layer).
        if value is None:
            return None
        prefix = "sha256:"
