...
from llm_router_utils.sglang.srt.utils import is_remote_url, logger
from llm_router_utils.sglang.srt.utils.patch_tokenizer import patch_tokenizer
...
def get_tokenizer(
    ...
    **kwargs,
    ...
    if tokenizer_name.endswith(".json"):
        from llm_router_utils.sglang.srt.tokenizer.tiktoken_tokenizer import TiktokenTokenizer
